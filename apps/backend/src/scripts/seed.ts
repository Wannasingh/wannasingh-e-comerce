...
const categories: ProductTemplate[] = [
  {
    ...
    materials: [
      { label: "Outer Shell", value: "3L GORE-TEX PRO" },
      { label: "Membrane", value: "ePTFE Waterproof" },
      { label: "Backer", value: "20D Micro Scrim" },
      { label: "Hardware", value: "YKK Aquaguard®" },
    ],
    features: [
      {
        icon: "water_drop",
        title: "Waterproof Shield",
        desc: "28,000mm hydrostatic head rating with fully taped seams for total weather protection.",
      },
      {
        icon: "wind_power",
        title: "Wind Barrier",
        desc: "100% windproof membrane blocks all wind penetration while maintaining breathability.",
      },
      {
        icon: "shield",
        title: "Abrasion Guard",
        desc: "Reinforced high-wear zones with recycled polymer composites for maximum durability.",
      },
      {
        icon: "flare",
        title: "Retro-Reflective",
        desc: "Integrated retro-reflective elements for low-light visibility.",
      },
    ],
    specs: [
    ...
    priceRange: [55000, 125000],
    climateClass: "ARCTIC / WET",
  },
  {
    category: "Mid-Layer",
    series: "Thermal System",
    prefix: "ML",
    names: [
      "Kinetic Insulator",
      "Orbital Fleece",
    ...
    materials: [
      { label: "Body", value: "Polartec Power Stretch" },
      { label: "Insulation", value: "PrimaLoft Gold Active" },
      { label: "Panels", value: "4-Way Stretch Softshell" },
      { label: "Hardware", value: "YKK Coil Zips" },
    ],
    features: [
      {
        icon: "thermostat",
        title: "Active Insulation",
        desc: "Breathes during high-output activities while retaining warmth at rest.",
      },
      {
        icon: "wind_power",
        title: "4-Way Stretch",
        desc: "Power stretch panels deliver unrestricted mobility across full range of motion.",
      },
      {
        icon: "shield",
        title: "Moisture Wicking",
        desc: "Advanced moisture management keeps core temperature regulated.",
      },
      {
        icon: "flare",
        title: "Quick Dry",
        desc: "Rapid-dry fabric technology minimizes moisture retention.",
      },
    ],
    specs: [
      { label: "Warmth", value: "0.85 CLO" },
      { label: "Weight", value: "280g" },
      { label: "Stretch", value: "4-WAY" },
      { label: "Dry Time", value: "< 45min" },
    ],
    priceRange: [22000, 55000],
    climateClass: "ACTIVE / ALPINE",
  },
  {
    category: "Bottoms",
    series: "Mobility System",
    prefix: "BT",
    names: [
      "Neutron Cargo Pant",
      "Tactical Trouser",
    ...
    materials: [
      { label: "Fabric", value: "Ripstop Nylon 6,6" },
      { label: "Reinforcement", value: "Cordura® Knee Panels" },
      { label: "Waistband", value: "Elastic + D-Ring Belt" },
      { label: "Hardware", value: "YKK Zips / Snaps" },
    ],
    features: [
      {
        icon: "hiking",
        title: "Articulated Knees",
        desc: "Pre-curved knee construction for unrestricted movement.",
      },
      {
        icon: "shield",
        title: "Ripstop Build",
        desc: "High-tenacity ripstop nylon resists tearing and abrasion.",
      },
      {
        icon: "wind_power",
        title: "Gusseted Crotch",
        desc: "Diamond gusset allows full range of motion.",
      },
      {
        icon: "water_drop",
        title: "DWR Finish",
        desc: "Durable water repellent treatment sheds moisture.",
      },
    ],
    specs: [
      { label: "Fabric", value: "RIPSTOP 6,6" },
      { label: "Weight", value: "320g" },
      { label: "Pockets", value: "8 TOTAL" },
      { label: "DWR", value: "C6 TREATED" },
    ],
    priceRange: [18000, 45000],
    climateClass: "ALL-SEASON / FIELD",
  },
  {
    category: "Base Layer",
    series: "Core System",
    ...
    materials: [
      { label: "Fabric", value: "Merino/Synthetic Blend" },
      { label: "Weight", value: "180 GSM" },
      { label: "Treatment", value: "Anti-Microbial" },
      { label: "Seams", value: "Flatlock Construction" },
    ],
    features: [
      {
        icon: "thermostat",
        title: "Temperature Regulation",
        desc: "Natural merino fibers regulate body temperature.",
      },
      {
        icon: "water_drop",
        title: "Moisture Transport",
        desc: "Advanced wicking pulls moisture from skin.",
      },
      {
        icon: "shield",
        title: "Anti-Odor",
        desc: "Natural anti-microbial properties resist odor.",
      },
      {
        icon: "flare",
        title: "Next-to-Skin",
        desc: "Ergonomic body-mapped fit for zero-bulk layering.",
      },
    ],
    specs: [
      { label: "Fabric", value: "MERINO 180GSM" },
      { label: "Weight", value: "145g" },
      { label: "Fit", value: "BODY-MAPPED" },
      { label: "Odor Control", value: "72HR+" },
    ],
    priceRange: [8500, 18000],
    climateClass: "ALL-SEASON / CORE",
  },
  {
    category: "Accessories",
    series: "Utility Module",
    prefix: "AC",
    names: [
      "Chronos Balaclava",
      "Tactical Glove",
    ...
    materials: [
      { label: "Body", value: "Cordura® Nylon" },
      { label: "Lining", value: "Fleece / Mesh" },
      { label: "Closure", value: "Fidlock® Magnetic" },
      { label: "Hardware", value: "Duraflex® Buckles" },
    ],
    features: [
      {
        icon: "shield",
        title: "Durable Build",
        desc: "Military-specification Cordura nylon construction.",
      },
      { icon: "wind_power", title: "Modular Design", desc: "MOLLE-compatible attachment points." },
      {
        icon: "water_drop",
        title: "Weather Sealed",
        desc: "Sealed seams and water-resistant coatings.",
      },
      {
        icon: "flare",
        title: "Reflective Details",
        desc: "Strategic reflective elements for low-light.",
      },
    ],
    specs: [
      { label: "Material", value: "CORDURA® 500D" },
      { label: "Weight", value: "85g" },
      { label: "Attachment", value: "MOLLE" },
      { label: "Water Resist", value: "YES" },
    ],
    priceRange: [3500, 16000],
    climateClass: "ALL-SEASON / UTILITY",
  },
  {
    category: "Vests",
    series: "Carry System",
    ...
    materials: [
      { label: "Body", value: "Cordura 500D Nylon" },
      { label: "Straps", value: 'Nylon Webbing 1"/2"' },
      { label: "Buckles", value: "Woojin Quick-Deploy" },
      { label: "Attachment", value: "MOLLE-II Compatible" },
    ],
    features: [
      {
        icon: "shield",
        title: "MOLLE Matrix",
        desc: "Multi-point MOLLE attachment grid for modular storage.",
      },
      {
        icon: "wind_power",
        title: "Load Distribution",
        desc: "Ergonomic harness distributes weight.",
      },
      {
        icon: "water_drop",
        title: "Cordura Build",
        desc: "Military-spec Cordura nylon for extreme durability.",
      },
      { icon: "flare", title: "Quick-Deploy", desc: "Rapid-access buckle system for fast on/off." },
    ],
    specs: [
      { label: "Capacity", value: "4-8L" },
      { label: "Attachment", value: "12-POINT MOLLE" },
      { label: "Material", value: "CORDURA 500D" },
      { label: "Weight", value: "450g" },
    ],
    priceRange: [22000, 48000],
    climateClass: "ALL-SEASON / TACTICAL",
  },
  {
    category: "Footwear",
    ...
    materials: [
      { label: "Upper", value: "Nubuck Leather + Cordura" },
      { label: "Membrane", value: "GORE-TEX Lining" },
      { label: "Midsole", value: "EVA + TPU Stabilizer" },
    ...
    features: [
      ...
      {
        icon: "water_drop",
        title: "GTX Waterproof",
        desc: "GORE-TEX membrane for reliable waterproofing.",
      },
...
function generateProducts(): ProductInput[] {
  ...
  for (const cat of categories) {
    ...
    for (let i = 0; i < targetCount; i++) {
      ...
      const version =
        i < cat.names.length ? "" : ` V${String(Math.floor(i / cat.names.length) + 1)}`;
      ...
      const priceAmount =
        cat.priceRange[0] + Math.floor(Math.random() * (cat.priceRange[1] - cat.priceRange[0]));
      ...
      products.push({
        ...
        variants: [
          {
            ...
            sku: `${sku}-S`,
            options: { Size: "S" },
            prices: [{ amount: roundedPrice, currency_code: "usd" }],
          },
          {
            title: "M",
            sku: `${sku}-M`,
        ...
        metadata: {
          ...
          quickSpecs: [
            ...
            {
              label: "Weight",
              value: cat.specs.find((s) => s.label === "Weight")?.value ?? "350g",
            },
            { label: "Warranty", value: "LIFETIME" },
          ],
          images: {
...
export default async function seed({ container }: ExecArgs): Promise<void> {
  ...
  for (let i = 0; i < productsToSeed.length; i += BATCH_SIZE) {
    ...
    try {
      ...
      logger.info(
        `Batch ${String(Math.floor(i / BATCH_SIZE) + 1)}: Seeded ${String(result.length)} (total: ${String(seeded)}/${String(productsToSeed.length)})`,
      );
    } catch (error: unknown) {
